...
describe User do
  describe "Devise Attributes" do
    it { should have_fields(:email, :encrypted_password).of_type(String).
      with_default_value_of("") }
    it { should have_fields(:reset_password_token, :current_sign_in_ip,
      :last_sign_in_ip).of_type(String) }
